...
namespace PersonalProjectNotes.Services.Interfaces
{
    public interface IActivityService
    {
        ...
        public Task AddActivityToBoard(Guid boardId, UserAction userAction, Guid userId, Board? previousBoardState = null, ListCart? deleteListCart = null, ListCart? CreatelistCart = null);
